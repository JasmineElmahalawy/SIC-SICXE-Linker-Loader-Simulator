...
class Sic:
    def __init__(self, master) -> None:
        ...
        self.filepath = ""
        menu = Tk()
        menu.geometry("900x100")
        menu.title("absolute Loader")
        labelframe = LabelFrame(menu, text="GENERATE ABSOLUTE LOADER FROM SIC PROGRAM", font=("Arial", 16, "bold"), padx=50, pady=50)
        labelframe.pack()
        labelframe.config(bg="YELLOW", fg="GREEN")
        lb = Label(labelframe, text="Import HTE file .txt")
        lb.pack()
